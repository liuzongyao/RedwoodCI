...
exports.rebaseInteractive = function(workdir,files,comment,callback){
    var git  = spawn('git',['rebase','-i'],{env:{REDWOODHQ_COMMITCOMMENT:comment,REDWOODHQ_GITWORKINGDIR:workdir,REDWOODHQ_FILES:files,GIT_EDITOR:'"'+process.execPath+'" "'+path.resolve(__dirname,'../gitinterface/rebaseEdit.js').replace(/\\/g, '/')+'"'},cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.filesInCommit = function(workdir,commit,callback){
    var git  = spawn('git',['diff-tree','--no-commit-id','--name-only','-r',commit],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.changeOrginURL = function(workdir,newURL,callback){
    var git  = spawn('git',['remote','set-url','origin',newURL],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.rebaseContinue = function(workdir,callback){
    var git  = spawn('git',['rebase','--continue'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.rebase = function(workdir,callback){
    var git  = spawn('git',['rebase','origin','master'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.attachHEAD = function(workdir,callback){
    var git  = spawn('git',['status'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.checkoutFileFromHead= function(workdir,name,callback){
    var git  = spawn('git',['checkout','HEAD^',name],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.pointBranchToMaster= function(workdir,name,callback){
    var git  = spawn('git',['checkout','-B','master',name],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.createBranch= function(workdir,name,callback){
    var git  = spawn('git',['checkout','-b',name],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.deleteBranch= function(workdir,name,callback){
    var git  = spawn('git',['branch','-d',name],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.status = function(workdir,callback){
    var git  = spawn('git',['status','-s'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.resetFile = function(workdir,file,callback){
    var git  = spawn('git',['reset','--',file],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.reset = function(workdir,callback){
    var git  = spawn('git',['reset','--hard','origin/master'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.rebaseAbort = function(workdir,callback){
    var git  = spawn('git',['rebase','--abort'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.findText = function(workdir,text,patternType,caseSensitive,relativePath,callback){
    ...
    var git  = spawn('git',args,{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.rebaseSkip = function(workdir,callback){
    var git  = spawn('git',['rebase','--skip'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.getParentCommit = function(workdir,commit,callback){
    var git  = spawn('git',['rev-list',commit+"..master",'--first-parent'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.acceptTheirs = function(workdir,filePath,callback){
    var git  = spawn('git',['checkout','--theirs',"--",filePath],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.isBinary = function(workdir,filePath,callback){
    var git  = spawn('git',['diff-tree','-p',"4b825dc642cb6eb9a060e54bf8d69288fbee4904",'HEAD','--',filePath],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.fileLogNotPushed = function(workdir,filePath,callback){
    var git  = spawn('git',['log','origin/master..HEAD','--simplify-merges','--reverse','--pretty=format:%H',"--",filePath],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.fileLog = function(workdir,filePath,callback){
    var git  = spawn('git',['log','--pretty=format:%H||%an||%ad||%s','--simplify-merges',"--",filePath],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.filesInConflict = function(workdir,callback){
    var git  = spawn('git',['diff','--name-only','--diff-filter=U'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.commitsSinceDate = function(workdir,date,callback){
    var git  = spawn('git',['rev-list','--count','--since='+date,'HEAD'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.lsFiles = function(workdir,query,callback){
    ...
    var git  = spawn('git',params,{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.filesNotPushed = function(workdir,status,repo,callback){
    ...
    var git  = spawn('git',['diff',statusOption,repo],{cwd: workdir,timeout:300000});
    //var git  = spawn('git',['diff','--name-only','origin/master', 'HEAD'],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.showFileContents = function(workdir,file,version,callback){
    var git  = spawn('git',['show',version+':'+file],{cwd: workdir,timeout:300000});
    var cliData = "";
...
exports.initBare = function(workdir,callback){
    var git  = spawn('git',['--bare','init'],{cwd: workdir,timeout:300000});
...
exports.setGitUser = function(workdir,userName,eMail,callback){
    var git  = spawn('git',['config','user.name',userName],{cwd: workdir,timeout:300000});
    ...
    git.on('close', function (code) {
        var git2  = spawn('git',['config','user.email',eMail],{cwd: workdir,timeout:300000});
...
exports.init = function(workdir,callback){
    var git  = spawn('git',['init'],{cwd: workdir,timeout:300000});
...
exports.addRemote = function(workdir,name,url,callback){
    var git  = spawn('git',['remote','add',name,url],{cwd: workdir,timeout:300000});
...
exports.removeRemote = function(workdir,name,callback){
    var git  = spawn('git',['remote','remove',name],{cwd: workdir,timeout:300000});
...
exports.push = function(workdir,callback){
    ...
    var git  = spawn('git',['push','origin','master'],{cwd: workdir,timeout:300000});
    var error = "";
...
exports.pushSkipCommits = function(workdir,skipCommits,callback){
    common.logger.info("push");
    var git  = spawn('git',['push','origin','HEAD~'+skipCommits+':master'],{cwd: workdir,timeout:300000});
...
exports.pushDryRun = function(workdir,callback){
    common.logger.info("push");
    var git  = spawn('git',['push','origin','master','--dry-run'],{cwd: workdir,timeout:300000});
...
exports.pushRemote = function(workdir,repoName,branch,callback){
    //var git  = spawn('git',['pull','--rebase','origin','master'],{env:{GIT_EDITOR:'"'+process.execPath+'" "'+path.resolve(__dirname,'../gitinterface/echoEdit.js').replace(/\\/g, '/')+'"'},cwd: workdir,timeout:300000});
    var git  = spawn('git',['push',repoName,branch],{env:{HOME:workdir},cwd: workdir,timeout:300000});
...
exports.pullRemote = function(workdir,repoName,branch,callback){
    ...
    //var git  = spawn('git',['pull','--rebase','origin','master'],{env:{GIT_EDITOR:'"'+process.execPath+'" "'+path.resolve(__dirname,'../gitinterface/echoEdit.js').replace(/\\/g, '/')+'"'},cwd: workdir,timeout:300000});
    var git  = spawn('git',['pull','--no-edit',repoName,branch],{env:{HOME:workdir},cwd: workdir,timeout:300000});
...
exports.pull = function(workdir,callback){
    common.logger.info("pull");
    //var git  = spawn('git',['pull','--rebase','origin','master'],{env:{GIT_EDITOR:'"'+process.execPath+'" "'+path.resolve(__dirname,'../gitinterface/echoEdit.js').replace(/\\/g, '/')+'"'},cwd: workdir,timeout:300000});
    var git  = spawn('git',['pull','origin','master'],{env:{HOME:process.env.HOME,GIT_EDITOR:'"'+process.execPath+'" "'+path.resolve(__dirname,'../gitinterface/echoEdit.js').replace(/\\/g, '/')+'"'},cwd: workdir,timeout:300000});
...
exports.clone = function(workdir,dirToClone,callback){
    ...
    var git  = spawn('git',['clone',dirToClone,'.'],{cwd: workdir,timeout:300000});
...
exports.add = function(workdir,file,callback){
    ...
    var git  = spawn('git',['add',file],{cwd: workdir,timeout:300000});
...
exports.commitForMerge = function(workdir,file,message,callback){
    ...
    var git  = spawn('git',['commit','-i',file,'-m',message],{cwd: workdir,timeout:300000});
...
exports.commit = function(workdir,file,message,callback){
    ...
    var git  = spawn('git',arguments,{cwd: workdir,timeout:300000});
...
exports.rename = function(workdir,file,newName,callback){
    var git  = spawn('git',['mv',file,newName],{cwd: workdir,timeout:300000});
...
exports.delete = function(workdir,file,callback){
    ...
    if (stats.isDirectory() == true){
        git  = spawn('git',['rm','-r',file],{cwd: workdir,timeout:300000});
    }
    else{
        git  = spawn('git',['rm','-f',file],{cwd: workdir,timeout:300000});
    }
...
exports.commitAll = function(workdir,callback){
    var git  = spawn('git',['commit','-a','-m','auto comment'],{cwd: workdir,timeout:300000});
...
exports.addAll = function(workdir,callback){
    var git  = spawn('git',['add','-A'],{cwd: workdir,timeout:300000});
...
exports.gitFetch = function(workdir,callback){
    var git  = spawn('git',['fetch'],{cwd: workdir,timeout:300000});
